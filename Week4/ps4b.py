...
def playGame(wordList):
   ...
   # print("playGame not yet implemented.") # <-- Remove this when you code this function
    ...
    count = 0
    while choice != 'e' :
        if( choice == 'n' or choice == 'r' or choice == 'e'):
            if count == 0 and choice == 'r':
                print("You have not played a hand yet. Please play a new hand first!")
            else:
                choiceToPlay = input("Enter u to have yourself play, c to have the computer play: ")
                while(choiceToPlay != 'u' and choiceToPlay != 'c'):
